...
-(void)initializePickerViewInView: (UIView *)view
  ...
  _pickerViewContainerView = [[UIView alloc] initWithFrame:view.frame];
  ...
  _pickerContainerView = [[UIView alloc] initWithFrame:CGRectMake(0.0, _pickerViewContainerView.bounds.size.height - 260.0, _pickerViewContainerView.bounds.size.width, 275.0)];
