...
#define kBackGroundColor [UIColor colorWithRed:30/255.0 green:30/255.0 blue:34/255.0 alpha:1];
#pragma mark - Helpers
...
- (void)setButtonStyle:(JGActionSheetButtonStyle)buttonStyle forButton:(UIButton *)button {
    ...
    else if (buttonStyle == JGActionSheetButtonStyleCustomer) {
        font = [UIFont systemFontOfSize:16.0f];
        titleColor = [UIColor redColor];
        
        backgroundColor = [UIColor colorWithRed:26/255.0 green:26/255.0 blue:30/255.0 alpha:1];
        borderColor = [UIColor colorWithRed:30/255.0 green:30/255.0 blue:34/255.0 alpha:1];
    }
