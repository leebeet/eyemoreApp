...
- (void)pulseRing {
    ...
    [self.baseView insertSubview:pulseRingView belowSubview:self.view];
...
//        [pulseRingView setFrame:CGRectMake(0, 0, 400, 214)];
//        pulseRingView.center = self.view.center;
...
- (UIView *)createPulseRing {
    ...
    //以view的形状扩散 ＋ 2。0的倒角
    //pulseRingView.layer.cornerRadius = 2.0f;
