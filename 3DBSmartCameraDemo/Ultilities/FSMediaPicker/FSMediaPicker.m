...
#define kTakePhotoString NSLocalizedString(@"Take photo", nil)
#define kSelectPhotoFromLibraryString NSLocalizedString(@"Select photo from photo library", nil)
#define kRecordVideoString NSLocalizedString(@"Record video", nil)
#define kSelectVideoFromLibraryString NSLocalizedString(@"Select video from photo library", nil)
#define kCancelString NSLocalizedString(@"Cancel", nil)
