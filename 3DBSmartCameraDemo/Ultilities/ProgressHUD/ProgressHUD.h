...
#define HUD_STATUS_COLOR		[UIColor lightGrayColor]

#define HUD_SPINNER_COLOR		[UIColor colorWithRed:185.0/255.0 green:220.0/255.0 blue:47.0/255.0 alpha:1.0]
#define HUD_BACKGROUND_COLOR	[UIColor colorWithRed:20/255.0 green:20/255.0 blue:24/255.0 alpha:1]//[UIColor colorWithWhite:0.0 alpha:0.1]
...
//BLModified
+ (void)show:(NSString *)status view:(UIView *)view Interaction:(BOOL)Interaction;
