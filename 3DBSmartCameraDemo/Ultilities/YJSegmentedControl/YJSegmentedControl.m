...
- (void)AddSegumentArray:(NSArray *)SegumentArray{
    ...
    for (int i = 0; i < SegumentArray.count; i++) {
        ...
        if (i == 0) {
            ...
            //buttonDownView =[[UIView alloc]initWithFrame:CGRectMake(i * witdthFloat, 0, witdthFloat, 2)];
            //BLModified
            [buttonDownView setBackgroundColor:self.buttonDownColor];
            //[buttonDownView setBackgroundColor:[UIColor clearColor]];
...
-(void)selectTheSegument:(NSInteger)segument{
    ...
    if (self.selectSeugment != segument) {
        ...
        [UIView animateWithDuration:0.2 animations:^{
            ...
            //[buttonDownView setFrame:CGRectMake(segument * witdthFloat,0, witdthFloat, 2)];
        }];
