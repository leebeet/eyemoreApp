...
#define kWarmingTypeColor [UIColor redColor]
#define kSuccessTypeColor [UIColor colorWithRed:26/255.0 green:26/255.0 blue:30/255.0 alpha:1]
#define MESSAGE_H 60
...
- (instancetype)initWithTitle:(NSString *)title
	...
	if (self = [self init]) {
		...
		if (self.type == JRMessageViewTypeSuccess) {
			...
			self.backgroundColor = kSuccessTypeColor;
			...
			self.backgroundColor = kWarmingTypeColor;
...
- (void)layoutSubviews {
    ...
    else if (self.messagePosition == BLMessagePositionAfterStatuBar) {
        self.messageOriginY = 18;
        self.messageSimY = -self.messageHeight;
        self.messageMaxY = 18;
...
- (void)tapAction:(id)sender {
    [self.delegate didTappedOnJRMessageView:self];
